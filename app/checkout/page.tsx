  ...
  if (cart.length === 0) {
    return (
      <div className="max-w-2xl mx-auto px-4 py-12 text-center">
        ...
        <a href="/listings" className="text-[#2E8B57]">Browse listings</a>
      </div>
    );
  }
        ...
        <div className="md:col-span-3">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <select name="paymentMethod" value={formData.paymentMethod} onChange={handleChange} className="w-full border rounded-2xl px-5 py-3">
            ...
            >
              {loading ? 'Processing Order...' : `Pay R${total.toLocaleString()}`}
            </button>
          </form>
        </div>

        {/* Order Summary */}
        <div className="md:col-span-2 bg-white border rounded-2xl p-6 h-fit">
